package uo270160.mp.s2.analyzer.model;
...
public class WordAnalyzer {
	...
	/**
	 * Constructor que crea un objeto analizador de la palabra pasada como parámetro
	 * 
	 * @param aWord  La palabra a ser analizada
	 */
	public WordAnalyzer(String aWord) {
		checkParameter(aWord == null, "Parámetro null");
		word = aWord;
	}
	 ...
	 * aparece al menos dos veces en posiciones adyacentes. Por ejemplo, 'l' está repetida
	 * en  "pollo", pero 'o' no está.
	 * 
	 ...
	 * <i>múltiple</i> si aparece al menos dos veces en la palabra, no necesariamente
	 * en posiciones adyacentes. Por ejemplo, 'o' y 'l' son múltiples en "pollo",
	 * pero 'p' no es.
	 * 
	...
	/**
	 * /**
	 * Encuentra la posición de un carácter en la palabra, comenzando en una posición específica.
	 *  
	 * @param c El carácter que se quiere encontrar
	 * @param pos La posición de comienzo
	 * @return La posición del carácter en la palabra, o -1 si el carácetr no está en la palabra
	 */
	...
	public int countGroupsOfRepeatedCharacters() {
		int count = 0;
		for (int i = 0; i < word.length() - 1; i++) {
			if (word.charAt(i) == word.charAt(i + 1)) {   // encuentra una repetición
	...
	private void checkParameter(boolean condition, String string) {
		if(condition) {
